...
describe('Helpers...', () => {
    ...
    it.only('Its...', () => {
        ...
        const obj2 = {nome:'User', idadade:20, endereco: {rua: 'dos bobos'}}
        cy.wrap(obj2).its('endereco').should('have.property', 'rua')
        cy.wrap(obj2).its('endereco').its('rua').should('contain', 'dos bobos')
        cy.wrap(obj2).its('endereco.rua').should('contain', 'dos bobos')
        cy.visit('https://wcaquino.me/cypress/componentes.html')
